...
Engine_PhysicsManifold CollisionShape_IntersectionAABBxCircle(Engine_AABB box1, Engine_Matrix3x2 bodyTransform1, Engine_Circle box2, Engine_Matrix3x2 bodyTransform2);
